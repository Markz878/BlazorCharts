    ...
    public partial class StackedBarChartPage
    {
        ...
        protected override void OnInitialized()
        {
            data = new StackedBarSeries(
                ...
                true,
                new StackedBarSerie("Red series", "rgba(255,50,15,0.75)", "black", Enumerable.Range(0, 10).Select(x => new StackedBarItem((x + 1) * 100d, Enumerable.Range(0, 5).Select(x => $"Red item key {x}: Red item value {x}"))).ToList()),
